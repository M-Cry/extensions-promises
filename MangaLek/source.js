...
const MangaLekMadaraTemplate_1 = require("./MangaLekMadaraTemplate");
...
class MangaLek extends MangaLekMadaraTemplate_1.Madara {
    constructor() {
        super(...arguments);
        this.baseUrl = MANGALEK_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.UNKNOWN;
    }
}
exports.MangaLek = MangaLek;

},{"./MangaLekMadaraTemplate":27,"paperback-extensions-common":4}],27:[function(require,module,exports){
"use strict";
...
class Madara extends paperback_extensions_common_1.Source {
    constructor() {
        ...
        this.parser = new MangalekParser_1.Parser();
    }
    ...
    getNumericId(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.CloudFlareError(data.status);
            let $ = this.cheerio.load(data.data);
            let numericId = $("script#wp-manga-js-extra")
                .get()[0]
                .children[0].data.match('"manga_id":"(\\d+)"')[1];
            if (!numericId) {
...
},{"./MangalekParser":28,"paperback-extensions-common":4}],28:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
class Parser {
    parseMangaDetails($, mangaId, source) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let summary = this.decodeHTMLEntity($("div.description-summary").first().text())
                .replace("Show more", "")
                .trim();
            let image = encodeURI(this.getImageSrc($("div.summary_image img").first()));
            let rating = $("span.total_votes").text().replace("Your Rating", "");
            let isOngoing = $("div.summary-content", $("div.post-content_item").last())
                .text()
                .toLowerCase()
                .trim() == "ongoing";
            let genres = [];
            ...
            let tagSections = [
                createTagSection({ id: "0", label: "genres", tags: genres }),
            ];
    ...
    parseChapterList($, mangaId, source) {
        ...
        let realTitle = (_a = $("a", selector.first())
        ...
        for (let obj of selector.toArray()) {
            ...
            let releaseDate = $("i", $(obj)).length > 0
                ? $("i", $(obj)).text()
                : (_c = $(".c-new-tag a", $(obj)).attr("title")) !== null && _c !== void 0 ? _c : "";
    ...
    parseSearchResults($, source) {
        ...
        for (let obj of $(source.searchMangaSelector).toArray()) {
            let id = ((_a = $("a", $(obj)).attr("href")) !== null && _a !== void 0 ? _a : "")
                .replace(`${source.baseUrl}/${source.sourceTraversalPathName}/`, "")
                .replace(/\/$/, "");
            let title = createIconText({
                text: this.decodeHTMLEntity((_b = $("a", $(obj)).attr("title")) !== null && _b !== void 0 ? _b : ""),
            });
    ...
    filterUpdatedManga($, time, ids, source) {
        ...
        let updatedManga = [];
        for (let obj of $("div.page-item-detail").toArray()) {
            let id = (_b = (_a = $("a", $("h3.h5", obj))
                .attr("href")) === null || _a === void 0 ? void 0 : _a.replace(`${source.baseUrl}/${source.sourceTraversalPathName}/`, "").replace(/\/$/, "")) !== null && _b !== void 0 ? _b : "";
            let mangaTime;
